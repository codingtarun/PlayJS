...
class AppsList extends CreateComponent{
    apps = [
        ...
        new AppBlueprint('LibraOffice','The Document Foundation','https://www.libreoffice.org/','A comprehensive, free office suite offering word processing, spreadsheets, presentations, and more, serving as a robust alternative to Microsoft Office.',true,true,4,'libreoffice.png'),
    ];
